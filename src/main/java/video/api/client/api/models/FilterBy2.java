...
public class FilterBy2 implements Serializable, DeepObject {
    ...
    public FilterBy2 mediaType(MediaTypeEnum mediaType) {
    ...
    public FilterBy2 continent(List<ContinentEnum> continent) {
    ...
    public FilterBy2 country(List<String> country) {
    ...
    public FilterBy2 deviceType(List<String> deviceType) {
    ...
    public FilterBy2 operatingSystem(List<String> operatingSystem) {
    ...
    public FilterBy2 browser(List<String> browser) {
    ...
    public FilterBy2 tag(String tag) {
        this.tag = tag;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        FilterBy2 filterBy2 = (FilterBy2) o;
        return Objects.equals(this.mediaId, filterBy2.mediaId) && Objects.equals(this.mediaType, filterBy2.mediaType)
                && Objects.equals(this.continent, filterBy2.continent)
