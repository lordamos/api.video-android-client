...
public class WebhooksApiTest extends AbstractApiTest {
    ...
    class get {
        ...
        public void responseWithStatus200Test() throws ApiException {
            ...
            assertThat(res.getEvents())
                    .containsExactlyElementsIn(Arrays.asList((Webhook.EventsEnum.VIDEO_ENCODING_QUALITY_COMPLETED)));
    ...
    class create {
        ...
        public void requiredParametersTest() {
            ...
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'webhooksCreationPayload' when calling create");

            e = assertThrows(ApiException.class, () -> api.create(new WebhooksCreationPayload()));
            assertThat(e).hasMessageThat()
                    .contains("Missing the required parameter 'webhooksCreationPayload.url' when calling create");
